function enable_color_change() {
    ...
    $(function() {
        ...
        function handlelogobg1(logobgskin) {
            $('.topbar nav .nav-wrapper .brand-logo').attr("data-logobg", logobgskin);
        };
...
function Aplicar_Preferencias(preferencias) {
  $('.topbar nav .nav-wrapper .brand-logo').attr("data-logobg", preferencias.LogoBg);
  $('#main-wrapper').attr("data-navbarbg", preferencias.NavbarBg);
  $('.topbar nav').attr("data-navbarbg", preferencias.NavbarBg);
  $('.left-sidebar .sidenav').attr("data-sidebarbg", preferencias.SidebarColor);
  $('body').attr("data-theme", preferencias.Theme ? 'dark' : 'light');
}
